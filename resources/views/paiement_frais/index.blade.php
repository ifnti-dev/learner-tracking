<x-app-layout>
    ...
    <div class="px-5 py-4 sm:px-6 sm:py-6 flex ">
        ...
        <div class="justify-end ml-auto">
            ...
            <x-primary-button>
                <a href="{{ route('paiement_frais.create',$apprenant) }}">
                    {{ __('Ajouter ') }}
                </a>
            </x-primary-button>
        </div>
            ...
            <div class="max-w-full overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse ($paiementFrais as $paiementFrais)
                        @if($paiementFrais->verse)
                        <tr class="hover:bg-gray-100  dark:hover:bg-gray-800 bg-green-100 dark:bg-green-800"> ">
                            @else
                        ...
                        <tr>
                            <td colspan="5" class="px-5 py-4 sm:px-6">
                                <div class="flex items-center justify-center">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                        Aucun paiement de frais de scolarité trouvé.
                                    </p>
                                </div>
                            </td>
                        </tr>
