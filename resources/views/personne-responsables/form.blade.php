<x-app-layout>
    <x-http-message-swal />
    @php
    $is_edit = isset($personneResponsable);
    $action = $is_edit ? route('personne-responsables.update', $personneResponsable->id) : route('personne-responsables.store');
    @endphp
    <div class="px-5 py-4 sm:px-6 sm:py-5 flex ">
        <h3
            class="text-base font-medium text-gray-800 dark:text-white/90">
            Ajouter un Tuteur/Parent
        </h3>
    ...
    <form action="{{ $action }}" method="POST">
        ...
        @method('PUT')
        <div
            class="  rounded-2xl  bg-white dark:border-gray-800 dark:bg-white/[0.03]">

            <div
                class="gap-4 grid grid-cols-12  border-gray-100 p-5 sm:p-6 dark:border-gray-800 ">
                <!-- Elements -->

                <div class="col-span-12 lg:col-span-6">
                    <x-input-label for="nom" :value="__('Nom')" />
                    <x-text-input id="nom" class="" type="text" name="nom" :value="old('nom', $personneResponsable->nom ?? '')" required autofocus autocomplete="username" />
                ...
                <div class="col-span-12 lg:col-span-6">
                    ...
                    <x-text-input id="prenom" class="" type="text" name="prenom" :value="old('prenom', $personneResponsable->prenom ?? '')" required autofocus autocomplete="username" />
                ...
                <div class="col-span-12 lg:col-span-3">
                    ...
                    <div
                        x-data="{ selectedType: '{{ old('type', $personneResponsable->type ?? '') }}' }"
                ...
                <div class="col-span-12 lg:col-span-5"
                    ...
                    <div class="relative">
                        ...
                        <x-number-input id="telephone" class="pl-[84px]" type="text" name="telephone" :value="old('telephone', $personneResponsable->telephone ?? '')" required autofocus autocomplete="username" />
                    </div>
