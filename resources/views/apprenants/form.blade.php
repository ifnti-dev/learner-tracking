<x-app-layout>
    ...
    <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6 bg-gray-50 dark:bg-gray-900 bg-red-600">
                                ...
                                <div>
                                    <select
                                        ...
                                        <option
                                            ...
                                            {{ $personne_reponsable->id == old('personne_reponsable_id') ? 'selected' : '' }}>
