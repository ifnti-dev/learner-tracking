                ...
                <div
                    ...
                    <div
                        ...
                        <div class="col-span-12 lg:col-span-6">
                            ...
                            <x-text-input id="nom" class="" type="text" name="nom" :value="old('nom')" required autofocus />
                        ...
                        <div class="col-span-12 lg:col-span-4">
                            ...
                            <x-text-input id="adresse" class="" type="text" name="adresse" :value="old('adresse')" required autofocus />
                        ...
                        <div class="col-span-12 space-x-2">
                            ...
                            <div class="flex space-x-2">
                                <div class="w-1/2">
                                    <select name="personnes_reponsable_id" id="personne_reponsables_id" class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                                        @foreach ($personnes_reponsables as $personnes_reponsable)
                                        <option value="{{ $personnes_reponsable->id }}" {{ old('personnes_reponsable_id') == $personnes_reponsable->id ? 'selected' : '' }}>
                        ...
                        <div class="col-span-12 lg:col-span-6">
                            ...
                            <x-text-input id="etablissement" class="" type="text" name="etablissement" :value="old('etablissement')" required autofocus />
