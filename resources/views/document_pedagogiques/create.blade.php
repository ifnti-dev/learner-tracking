        ...
        @csrf
            <div class="grid grid-cols-12 gap-6  border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                ...
                <div class="col-span-6">
                    ...
                    <x-text-input id="titre" name="titre" type="text" :value="old('titre')" required />
                    <x-input-error :messages="$errors->get('titre')" class="mt-2" />
                </div>
                <div class="col-span-6">
                    <x-input-label for="auteur" value="Auteur" />
                    <x-text-input id="auteur" name="auteur" type="text" :value="old('auteur')" required />
                ...
                <div class="col-span-6">
                    ...
                    <input id="quantite" name="quantite" type="number" value="{{ old('quantite') }}"
