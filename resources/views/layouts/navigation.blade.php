    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <button
                ...
                {{-- Icône Menu ordinateur (3 lignes courtes) --}}
                ...
                {{-- Icône Burger Mobile (Visible si la Sidebar est FERMÉE) --}}
                ...
                {{-- Icône Croix Mobile (Visible uniquement si la Sidebar est OUVERTE) --}}
                    ...
                    <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
                        <li>
                            <a
                                ...
                                {{-- Icône profil (garde celle du template) --}}
