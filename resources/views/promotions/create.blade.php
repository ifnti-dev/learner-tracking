            ...
            <div class="grid grid-cols-12 gap-6  border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                    ...
                    <div class="col-span-6 lg:col-span-6">
                        ...
                        <div class="col-span-6">
                            <x-input-label for="annee_id" value="Annee de creation" required />
                            ...
                            <x-input-error :messages="$errors->get('annee_id')" class="mt-2" />
                        </div>
                        ...
                        <div class="col-span-6 lg:col-span-6">
                            <x-input-label for="type" :value="__('Est Active')" required />
                            <div
                                x-data="{ selectedType: '{{ old('est_active') }}' }"
                                ...
                                <select
                                    ...
                                    <option value="">Est Active oui/non</option>
