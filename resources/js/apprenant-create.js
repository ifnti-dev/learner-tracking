...
const all_niveau = ['', 'CE2', 'CM1', 'CM2', '6ème trimestriel', '5ème trimestriel', '4ème trimestriel',
    '3ème trimestriel', 'Seconde trimestriel', 'Seconde semestriel', 'Première trimestriel', 'Première semestriel', 'Terminale trimestriel', 'Terminale semestriel']
...
function add_row() {
    ...
    if ([4, 5, 12, 13, 16, 17].includes(Number(niveau_id))) {
        ...
        if ([4].includes(Number(niveau_id))) {
        ...
        if ([8, 9].includes(Number(niveau_id))) {
            let th_special = `<th class=" special w-1/4 px-5 py-3 text-center text-theme-xs font-medium text-gray-500 dark:text-gray-400">
                                                BEPC
                                            </th>`;
...
const button_aide_financier = $('#aide_financier')


button_aide_financier.on('click', function () {
    const div_table_financement = $('#table_financement')
    
    div_table_financement.css({
        'display': 'block'
    });
